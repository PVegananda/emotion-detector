...
## TASK 3 - Activity 1: Code Showing Correct Output Format
**Points: 1**

The emotion_detector() function returns a consistently formatted dictionary. Here are the key code sections that implement the output format:

**Blank Input Format (lines 19-28):**
```python
if not text_to_analyze or text_to_analyze.strip() == "":
    return {
        "anger": None,
